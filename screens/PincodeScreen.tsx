...
type NavigationProp = StackNavigationProp<RootStackParamList, 'Pincode'>;
        ...
        >
          <View style={styles.content}>
            ...
            <TextInput
              ...
              right={<TextInput.Affix text={`${pincode.length}/6`} />}
            />
...
// Mock reverse geocoding function - replace with actual implementation
async function reverseGeocode(coords: { latitude: number; longitude: number }): Promise<string> {
  // In a real app, you would use a geocoding service here
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve("110001"); // Default pincode for demo
    }, 1000);
  });
}
